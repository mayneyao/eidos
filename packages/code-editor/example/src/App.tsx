...
import { FileType, MultiFileEditor, SimpleCodeEditor, type FileModel } from "../../src/index"
...
const createFileModel = (name: string, content: string): FileModel => ({
  id: name,
  name,
  path: name,
  content,
...
const testFiles: FileModel[] = [
  ...
  createFileModel("utils.ts", `// Utility functions file
          ...
          {useSimpleEditor ? (
            <>
              <div className="bg-gray-900 p-4 rounded border border-gray-700 mb-4">
                <h4 className="text-green-400 font-medium mb-2 m-0">✅ Simplified Version Includes:</h4>
                <ul className="text-sm text-gray-300 m-0 pl-6">
                  <li className="mb-1">Tabs (Tabs)</li>
                  <li className="mb-1">Editor Area (EditorArea)</li>
                  <li className="mb-1">Syntax highlighting and code completion</li>
              ...
              <div className="bg-gray-900 p-4 rounded border border-gray-700">
                <h4 className="text-red-400 font-medium mb-2 m-0">❌ Simplified Version Removes:</h4>
                <ul className="text-sm text-gray-300 m-0 pl-6">
            ...
            <>
              ...
              <div className="bg-gray-900 p-4 rounded border border-gray-700">
                <h4 className="text-teal-400 font-medium mb-2 m-0">Test Features:</h4>
                <ul className="text-sm text-gray-300 m-0 pl-6">
                  <li className="mb-1">Syntax highlighting - Keywords, strings, comments should have different colors</li>
                  <li className="mb-1">Code completion - Typing this.userService. should show method hints</li>
                  <li className="mb-1">Type checking - Type errors should have red wavy underlines</li>
                  <li className="mb-1">Cross-file references - a.ts referencing b.ts types should work normally</li>
                  <li className="mb-1">Hover hints - Hovering over variables should show type information</li>
                  <li className="mb-1 text-yellow-400">ESM imports - Supports libraries like lodash-es, axios, date-fns, uuid</li>
                  <li className="mb-1 text-yellow-400">Plugin system - ESM import resolver enabled</li>
                </ul>
              </div>
            </>
          )}
        ...
        <div className="flex-1 flex flex-col min-w-0 min-h-0">
          {useSimpleEditor ? (
            <SimpleCodeEditor
              ...
              initialOpenFiles={["a.ts", "b.ts", "utils.ts"]}
              initialActiveFileId="a.ts"
