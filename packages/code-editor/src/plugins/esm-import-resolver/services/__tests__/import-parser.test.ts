...
describe("ImportParser", () => {
  ...
  describe("parseImports", () => {
    ...
    it("should handle empty or invalid code gracefully", async () => {
      ...
      const invalidImports = await parser.parseImports(
        "invalid syntax {",
        "test.ts"
      )
  ...
  describe("resolveImportUrl", () => {
    it("should resolve third-party packages to esm.sh URLs", () => {
      ...
      expect(parser.resolveImportUrl("@babel/core")).toBe(
        "https://esm.sh/@babel/core"
      )
      expect(parser.resolveImportUrl("lodash@4.17.21")).toBe(
    ...
    it("should resolve Node.js builtins to esm.sh URLs", () => {
      ...
      expect(parser.resolveImportUrl("node:crypto")).toBe(
        "https://esm.sh/crypto"
      )
    })
    ...
    it("should leave relative imports unchanged", () => {
      ...
      expect(parser.resolveImportUrl("../../components")).toBe(
        "../../components"
      )
    })
  })
  ...
  describe("extractPackageName", () => {
    ...
    it("should extract package names from scoped packages", () => {
      ...
      expect(parser.extractPackageName("@excalidraw/excalidraw")).toBe(
    ...
    it("should extract package names from subpath imports", () => {
      ...
      expect(parser.extractPackageName("@babel/core/lib/transform")).toBe(
        "@babel/core"
      )
    })
    ...
    it("should handle version specifications", () => {
      ...
      expect(parser.extractPackageName("@babel/core@7.20.0")).toBe(
        "@babel/core"
      )
    })
  })
