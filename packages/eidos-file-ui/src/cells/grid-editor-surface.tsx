...
export function EidosFileGridEditorSurface({
  ...
  return (
    <div
      ...
      className={cn(
        "click-outside-ignore flex w-80 max-w-[calc(100vw-1rem)] flex-col overflow-hidden rounded-md border border-border/70 bg-popover text-popover-foreground [box-shadow:var(--floating-surface-shadow)]",
        className
      )}
      {...props}
    />
