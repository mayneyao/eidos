  ...
  return (
    ...
    >
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "eidos-file-root z-50 min-w-[8rem] max-w-[calc(100vw-1rem)] overflow-hidden rounded-md border border-border/70 bg-popover p-1 text-popover-foreground shadow-xs",
