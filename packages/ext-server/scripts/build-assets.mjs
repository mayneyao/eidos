...
const possibleClientPaths = [
  path.join(rootDir, '..', '..', 'node_modules', '@eidos.space', 'client', 'dist', 'index.mjs'), // monorepo root
  path.join(rootDir, 'node_modules', '@eidos.space', 'client', 'dist', 'index.mjs'), // local
];
...
`;
  ...
  console.log(`✓ Generated: src/generated/eidosClientJs.ts (from @eidos.space/client)`);
} else {
  console.warn(`⚠ @eidos.space/client/dist/index.mjs not found. Skipping eidosClientJs generation.`);
