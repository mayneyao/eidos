...
// @public (undocumented)
export const EIDOS_FILE_FORM_INPUT_FIELD_TYPES: readonly ["text", "number", "integer", "checkbox", "select", "multi-select", "rating", "date", "datetime", "url", "file"];
...
// @public (undocumented)
export const MUTABLE_BASE_FIELD_TYPES: readonly ["text", "number", "integer", "checkbox", "select", "multi-select", "rating", "date", "datetime", "url", "file"];
