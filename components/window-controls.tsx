...
export function WindowControls() {
  ...
  return (
    <div className="fixed top-0 right-0 z-50 flex items-center no-drag space-x-1 pr-2 pt-1">
      <button
      ...
      <button
        onClick={() => isMaximized ? window.eidos.unmaximizeWindow() : window.eidos.maximizeWindow()}
        className="p-1.5 hover:bg-gray-200/50 dark:hover:bg-gray-700 rounded-sm transition-colors"
      >
        <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
          {isMaximized ? (
            ...
            <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 7.5h14m0 0v9m0-9H5.25v9h14z" />
          )}
        </svg>
      </button>
