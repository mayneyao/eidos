...
export const headerIcons: SpriteMap = {
  [GridColumnIcon.HeaderRowID]: (p) => "🔢",
  [GridColumnIcon.HeaderCode]: (p) => "📝",
  [GridColumnIcon.HeaderString]: (p) =>
  ...
  [GridColumnIcon.HeaderNumber]: (p) => "🔢",
  [GridColumnIcon.HeaderBoolean]: (p) =>
