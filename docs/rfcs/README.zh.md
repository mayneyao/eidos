...
| 产品 UX           | 交付收尾中       | Files/Version、Diff/History、Settings、迁移与原生 Base 创建/编辑/重启/版本/恢复链路已验收；仍需完整 table-view 对齐和原生 row-conflict 验收。      |
...
下一顺序是完成剩余高价值 table-view 对齐和双 Space 原生 row-conflict 验收，随后进入文件化扩展。
