...
| Base format/runtime   | Delivery closure      | The standalone package supports structured queries, persisted multi-layout views, rich file/relation/live-formula/lookup fields, hardened file validation, table/field lifecycle, batch deletion, and streamed imports.            |
