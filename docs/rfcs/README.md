...
| Base format/runtime   | Delivery closure      | The standalone package and paged Grid support structured queries, multi-Grid lifecycle, rich file/relation/live-formula fields, table/field lifecycle, layout, batch deletion, and streamed imports.  |
