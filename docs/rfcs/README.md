...
| Product UX            | Delivery closure      | Files/Version, Diff/History, Settings, migration, and the native Base create/edit/restart/version/restore lifecycle are accepted. Full table-view parity and native row-conflict acceptance remain.                                |
...
table-view parity work and native two-Space row-conflict acceptance. File-based
extensions follow that gate.
