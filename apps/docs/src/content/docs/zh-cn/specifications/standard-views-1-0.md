---
title: "Eidos 标准视图 1.0（中文参考）"
description: "Eidos 标准视图 1.0（中文参考） 的说明性中文参考。英文规范文本拥有最终解释权。"
sidebar:
  order: 45
---
...
本文是 [Eidos UI 1.0](/zh-cn/specifications/ui-1-0/) 的 normative companion，不引入新的
...
- [Eidos File Format 1.0](/zh-cn/specifications/file-format-1-0/)
- [Eidos Runtime 1.0](/zh-cn/specifications/runtime-1-0/)
- [Eidos Adapter 1.0](/zh-cn/specifications/adapter-1-0/)
- [Eidos UI 1.0](/zh-cn/specifications/ui-1-0/)
