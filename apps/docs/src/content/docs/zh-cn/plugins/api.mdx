...
| `kind`                         | `"theme"`                | 主题 | 声明独立的 Eidos Lite 宿主主题，要求 Plugin API 1.6。             |
| `theme`                        | `ThemeDeclaration`       | 主题 | 浅色／深色语义变量表及可选的包内本地字体。                        |
...
主题插件没有可执行模块或其他贡献。主题变量定制这台设备上的 Lite 宿主界面，
不是单个插件视图。参见[主题开发流程](/zh-cn/plugins/workflow/#制作独立的-eidos-lite-主题)。
