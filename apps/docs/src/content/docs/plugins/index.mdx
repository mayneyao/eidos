...
- **Full projects (`eidos plugin create`):** Scaffolds a complete package directory with `plugin.json`, TypeScript, React, styles, and automated packaging into `.eidos-plugin` archives for distribution.
