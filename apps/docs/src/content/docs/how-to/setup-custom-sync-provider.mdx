...
<Aside type="note">
  Custom sync providers require an **active license**. Please activate your
  license in **Settings → Account** before proceeding.
</Aside>
...
4. **Enter Credentials**
   ...
   <Aside type="caution">
     Your credentials are encrypted and stored locally using your operating
     system's secure storage. They are never sent to any third-party servers.
   </Aside>
...
6. **Clone**
   ...
   <Aside type="tip">
     The clone time depends on the size of your space. Larger spaces with many
     files will take longer to download.
   </Aside>
...
<Aside type="danger">
  Deleting a provider only removes the configuration from Eidos. Your data
  remains in the S3 bucket. To completely delete the data, you need to manually
  delete it from your S3 service.
</Aside>
