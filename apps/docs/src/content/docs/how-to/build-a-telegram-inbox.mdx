...
2. **Create a script** to process incoming messages:

   Go to **Extensions → Scripts → Create Script**, and paste this:
...
3. **Connect your inbox** to the script:
...
3. Check your `messages` table in Eidos — it should appear within seconds!
