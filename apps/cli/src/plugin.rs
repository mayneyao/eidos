...
fn create(directory: &Path) -> Result<CommandOutput> {
    ...
    let package = json!({"name":name,"version":"0.1.0","private":true,"type":"module","scripts":{"check":"eidos plugin check","pack:plugin":"eidos plugin pack"},"devDependencies":{"@eidos.space/plugin-sdk":"^0.1.4","@eidos.space/plugin-tools":"^0.1.4"}});
