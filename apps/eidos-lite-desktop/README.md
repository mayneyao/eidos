...
Eidos Lite 0.1.11 is the current release. Local Spaces, editing, and version
history require no account. It uses Graft SDK 0.3.16 for durable merge state,
...
Graft runs through the published `@eidos.space/graft@0.3.16` Node-API SDK.
