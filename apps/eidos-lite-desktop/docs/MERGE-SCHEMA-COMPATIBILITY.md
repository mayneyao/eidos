...
Graft 0.3.25 automatically materializes compatible column/table/index/view/
...
Graft 0.3.25 returns structured `path_diagnostics` for skipped, corrupt, and
...
Graft 0.3.25 reports `schema_same_name_conflict` and safely completes either the
