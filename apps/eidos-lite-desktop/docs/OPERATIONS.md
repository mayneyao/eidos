...
The runtime pins published `@eidos.space/graft@0.3.17`; npm selects one of its
...
Graft 0.3.17 protects `applyMerge` with the reviewed HEAD, plan token, and clean
