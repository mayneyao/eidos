...
The runtime pins published `@eidos.space/graft@0.3.18`; npm selects one of its
...
Graft 0.3.18 protects `applyMerge` with the reviewed HEAD, plan token, and clean
