...
flowchart LR
  ...
  G -->|"one retained RepositorySession"| N["Official Node-API SDK 0.3.17"]
...
The SDK adapter pins published `@eidos.space/graft@0.3.17`,
...
the published Graft 0.3.17 declaration. `EIDOS_LITE_GRAFT_SDK_PATH` may select
