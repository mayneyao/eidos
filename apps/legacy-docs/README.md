# Eidos Legacy Documentation

This site is a read-only archive of the database-backed Eidos documentation.
New documentation lives in `apps/docs` and is published at
...
- [Legacy Documentation Site](https://legacy.docs.eidos.space)
