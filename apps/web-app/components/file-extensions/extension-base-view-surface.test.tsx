...
describe("ExtensionBaseViewSurface", () => {
  ...
  beforeEach(() => {
    ...
    mocks.openBaseView.mockReset().mockResolvedValue({
      packageId: "example.tasks",
      baseViewId: "example.tasks.cards",
      generation: "generation-1",
      source: "/* compiled Base view */",
    })
    ...
    Object.defineProperty(window, "eidos", {
      ...
      value: {
        fileExtensions: {
          openBaseView: mocks.openBaseView,
  ...
  it("initializes with Base metadata and serves bounded pages", async () => {
