...
import { SettingsSection, SettingsRows } from "../settings-surface"
...
export function GlobalAccountSettings() {
  ...
  return (
    <div className="space-y-8">
      {/* Account Section */}
      <SettingsSection title={t("settings.account.title", "Account")}>
        <SettingsRows>
      ...
      {isDesktopMode && (
        <SettingsSection
          title={t("settings.license.title", "License Management")}
          description={t(
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="font-medium text-amber-800 dark:text-amber-200">
                        {t("settings.account.loginRequired", "Login Required")}
                      </p>
