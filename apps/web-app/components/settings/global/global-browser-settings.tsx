...
export function GlobalBrowserSettings() {
  ...
  return (
    <div className="space-y-8">
      ...
      <SettingsSection
        title={t("settings.browser.searchEngines", "Search Engines")}
        actions={
          <Button
            variant="outline"
            size="sm"
        ...
        <SettingsRows>
          {allEngines.map((engine) => {
            ...
            return (
              <div
                key={engine.id}
                className="grid grid-cols-[1fr_100px_90px] gap-3 py-3 items-center"
              >
      ...
      <SettingsSection
        title={t("settings.browser.linkHandling", "Link Handling")}
      >
        <SettingsRows>
          <SettingsRow
            htmlFor="open-links-in-built-in-browser"
            title={t(
          ...
          >
            <Switch
              id="open-links-in-built-in-browser"
        ...
        {config.enableRawData && supportedWebsites.length > 0 && (
          <div className="border-t border-border/70 py-4 space-y-3">
