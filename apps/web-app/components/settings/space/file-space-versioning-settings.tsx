  ...
  return (
    <div className="space-y-8">
      <SettingsSection>
        <SettingsSectionHeader
          title={t(
            "space.settings.fileSpace.versioning.group",
            "Local history"
          )}
        />
        <SettingsRowSurface>
      ...
      <SettingsSection>
        <SettingsSectionHeader title="Remote sync" />
        <SettingsRowSurface>
          <div className="divide-y divide-border/70">
            <div className="flex min-h-[72px] flex-col gap-3 py-4 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
                ...
                <div className="min-w-0 flex-1 space-y-2">
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge
                        variant={remoteConfigured ? "secondary" : "outline"}
                      >
                    ...
                    <p className="text-sm leading-5 text-muted-foreground">
                      ...
                      remote. Local file changes are never uploaded until they
                      are committed.
                    </p>
                  </div>
                  <Input
