...
export function RelaySettings({ onCloseSettings }: RelaySettingsProps) {
  ...
  if (!isAuthenticated) {
    return (
      <div className="space-y-8">
        <SettingsSection
          title={t("space.settings.relay.service")}
          framed={false}
        >
  ...
  return (
    <div className="space-y-8">
      <SettingsSection title={t("space.settings.relay.service")}>
        <SettingsRow
          icon={
            <span
        ...
        {/* Message Statistics */}
        {hasMessages && (
          <div className="border-t border-border/70 py-4 flex items-center gap-2 flex-wrap">
                      ...
                      <div className="flex items-center gap-1.5 text-xs text-muted-foreground bg-muted px-2 py-1 rounded">
                        ...
                        {channel.handlerScriptId && (
                          <Button
                            ...
                            onClick={() => {
                              onCloseSettings?.()
                              navigate(`/extensions/${channel.handlerScriptId}`)
                            }}
                            title={t(
                              "space.settings.relay.openScript",
                              "Open Script"
