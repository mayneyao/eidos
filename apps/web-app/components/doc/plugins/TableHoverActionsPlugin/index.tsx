...
function TableHoverActionsContainer({
  ...
  return (
    <>
      {isShownRow && (
        <button
          className={"eidos_editor_theme__tableAddRows"}
          style={{ ...position }}
      ...
      {isShownColumn && (
        <button
          className={"eidos_editor_theme__tableAddColumns"}
          style={{ ...position }}
...
function getMouseInfo(event: MouseEvent): {
  ...
  if (target && target instanceof HTMLElement) {
    const tableDOMNode = target.closest<HTMLElement>(
      "td.eidos_editor_theme__tableCell, th.eidos_editor_theme__tableCell"
    )

    const isOutside = !(
      tableDOMNode ||
      target.closest<HTMLElement>("button.eidos_editor_theme__tableAddRows") ||
      target.closest<HTMLElement>(
        "button.eidos_editor_theme__tableAddColumns"
      ) ||
