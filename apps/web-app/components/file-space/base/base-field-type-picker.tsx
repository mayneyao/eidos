import type { CreateBaseFieldInput } from "@eidos.space/base"
import {
  Baseline,
  CalendarDays,
  CheckSquare,
...
export type BaseCreatableFieldType = CreateBaseFieldInput["type"]

export const BASE_FIELD_TYPE_GROUPS: FieldTypePickerGroup<BaseCreatableFieldType>[] =
  [
    {
      label: "Basic",
      options: [
...
export function BaseFieldTypePicker({
  value,
  onChange,
  disabled,
}: {
  value: BaseCreatableFieldType
  onChange: (value: BaseCreatableFieldType) => void
  disabled: boolean
}) {
  return (
    <FieldTypePicker
      value={value}
      groups={BASE_FIELD_TYPE_GROUPS}
      onChange={onChange}
      disabled={disabled}
