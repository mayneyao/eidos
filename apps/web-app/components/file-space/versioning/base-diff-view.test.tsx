  ...
  tables: [
    {
      ...
      changes: [
        ...
        },
        {
          operation: "insert",
          rowId: 2,
          values: ["2", "Ship Base diff", 0, "2026-07-12T01:00:00Z"],
          beforeValues: null,
        },
      ],
    },
...
describe("BaseDiffView", () => {
  ...
  it("shows table summaries and changed cell values", () => {
    act(() => root.render(<BaseDiffView file={file} />))
    ...
    expect(container.textContent).toContain("Ship Base diff")
    expect(container.textContent).toContain("SQLite indexes")
    expect(container.textContent).not.toContain("Base metadata")
  ...
  it("collapses and reopens one table without losing its summary", () => {
    ...
    expect(container.textContent).not.toContain("Ship Base diff")
    expect(container.textContent).toContain("+1")
  })
})
