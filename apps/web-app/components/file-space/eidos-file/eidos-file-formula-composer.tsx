...
function completionColumns(fields: EidosFileFieldInfo[]): UiColumn[] {
  return fields
...
export function EidosFileFormulaComposer({
  ...
  return (
    <div className="eidos-file-formula-composer min-h-0" aria-busy={disabled}>
      <div className="eidos-file-formula-composer-layout min-h-0">
        <div className="eidos-file-formula-editor-pane min-w-0 border-r">
          <div className="p-3">
            <CodeMirrorFormulaEditor
              ref={editorRef}
              value={formula}
          ...
          >
            ...
            <div className="min-w-0">
              {status === "checking" ? (
                <span>Checking against this Eidos File…</span>
              ) : status === "error" ? (
          ...
          <div className="eidos-file-formula-display-row flex items-center justify-between border-t px-3 py-2.5">
            <div>
        ...
        <aside className="eidos-file-formula-reference-pane flex min-h-0 flex-col bg-muted/15">
          ...
          <div className="eidos-file-formula-reference-list flex-1 overflow-y-auto py-1">
          ...
          <div className="eidos-file-formula-reference-detail mt-auto min-h-16 border-t px-2.5 py-2 text-[11px] text-muted-foreground">
            {selectedCompletion ? (
              <>
